...
import '../../../Controller/FacultiesMembersController/FeedbackControllerFacultie.dart';
import '../../Widgets/customAppBar.dart';
import '../../Widgets/customBotton.dart';
import '../../Widgets/customTextFiled.dart';
import '../../Widgets/customBottonNavegtor.dart';

class FacultiesMembersFeedbackScreen extends StatefulWidget {
  const FacultiesMembersFeedbackScreen({super.key});

  @override
  State<FacultiesMembersFeedbackScreen> createState() =>
      _FacultiesMembersFeedbackScreenState();
}

class _FacultiesMembersFeedbackScreenState
    extends State<FacultiesMembersFeedbackScreen> {
  late final FeedbackControllerFacultie controller;
  late final FacultiesMembersController facultiesController;

  @override
  void initState() {
    super.initState();
    controller = Get.put(FeedbackControllerFacultie());
    facultiesController = Get.find<FacultiesMembersController>();
    facultiesController.currentIndex.value = 3;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              children: [
                ...
                Obx(
                    ...
                    onTap: controller.isLoading.value
                        ? () {}
                        : () {
                      controller.submitFeedback(); // بدون async/await
                    },
                  ),
                ),
              ],
      ...
      bottomNavigationBar: Obx(
          ...
          currentIndex: facultiesController.currentIndex.value,
          onTap: facultiesController.onBottomNavTap,
         items: [
